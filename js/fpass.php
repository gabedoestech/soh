...
if(isset($_POST['btn-submit']))
{
    ...
    if($stmt->rowCount() == 1)
    {
       ...
       <br /><br />
       <a href='https://www.sealofhealth.com/resetpass.php?id=$id&code=$code'>click here to reset your password</a>
       <br /><br />
       Thank you.
       ";
    ...
    else
    {
     ...
     <button class='close' data-dismiss='alert'>&times;</button>
     <strong>Sorry!</strong> the email address provided cannot be found.
       </div>";
    }
}
?>
    ...
    <form class="form-signin" method="post">
        ...
        else
        {
            ...
            <div class='alert alert-info'>
                Please enter your email address. You will receive an email with a link to create a new password shortly.
            </div>
            <?php
        }
        ?>
