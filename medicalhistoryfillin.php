       ...
       <div class="mylogo">
        ...
        <div class="container">
          ...
          <?php
            ...
            $result = queryMysql("SELECT * FROM vitals WHERE vitalsID='$userID'");
            ...
            queryMysql("INSERT INTO vitals VALUES('$vitalsID', '$temperature', '$heart_rate',
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <?php echo "<input class='form-control' pattern='[0-9]{3}[/][0-9]{3}' placeholder='$bp' name='bp' required>";?>
            </div>
        </div>
